...
const Iotsolutions = () => {
    return (
        <div className="digital_Marketing_page_wepper">
            <Header />
            <section>
                    ...
                    <div className="fw-container">
                        ...
                        <div className="fw-row">
                            <div className="fw-col-xs-12 ">
                                ...
                                <p className="home-services-link"><b><Link to="/">Home</Link></b> {'>'} <b><Link
                                    to="/services">Services</Link> </b> {'>'} Iot Solutions
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="fw-row">
                            <div className="fw-col-xs-12 fw-col-sm-6 fw-col-md-6  ">
                                <p className="heading-services-subpage">IoT solutions encompass the technologies and systems that enable connected devices to collect
                                </p>
